...
alert("hello world");
alert(
  " alert it is special concept for adding some information before the page will load"
);
alert("after alerts ends you can see the page.");
// console log
console.log(
  "consol.log() it is a method that provide permison to add some messages."
);
console.log(
  "we will not see in the page but we can acces in inspect page -> console in browser"
);
